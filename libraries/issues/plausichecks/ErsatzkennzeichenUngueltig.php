 ...
 *
 */
class ErsatzkennzeichenUngueltig extends PlausiChecker
{
	public function executePlausiCheck($params)
	{
		...
		if (hasData($personRes))
		{
			...
			foreach ($persons as $person)
			{
				...
				$ersatzkennzeichenCheck = $this->_ci->dvuhcheckinglib->checkEkz($person->ersatzkennzeichen);
	...
	public function _getPersons(
		...
		$qry = "
			SELECT
				DISTINCT person_id, ersatzkennzeichen
			FROM
