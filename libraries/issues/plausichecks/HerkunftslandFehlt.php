 ...
 *
 */
class HerkunftslandFehlt extends PlausiChecker
{
	public function executePlausiCheck($params)
	{
		...
		$prestudentRes = $this->_getHerkunftslandFehlt(
	 ...
	 */
	private function _getHerkunftslandFehlt(
		...
		$qry = "
			...
			WHERE
				bisio.herkunftsland_code IS NULL
