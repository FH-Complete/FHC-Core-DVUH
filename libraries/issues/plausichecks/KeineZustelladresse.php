 ...
 *
 */
class KeineZustelladresse extends PlausiChecker
{
	...
	private function _getKeineHeimatadresse(
		...
		$qry = "
			...
			WHERE
				NOT EXISTS (SELECT 1 FROM public.tbl_adresse WHERE person_id = pers.person_id AND zustelladresse)
