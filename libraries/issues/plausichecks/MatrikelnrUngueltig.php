 ...
 *
 */
class MatrikelnrUngueltig extends PlausiChecker
{
	...
	private function _getPersons(
		...
		$qry = "
			SELECT
				DISTINCT ON (person_id) prestudent_id, person_id, pers.matr_nr, stg.studiengang_kz
			FROM
