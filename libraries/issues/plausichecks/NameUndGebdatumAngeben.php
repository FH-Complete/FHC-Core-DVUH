 ...
 *
 */
class NameUndGebdatumAngeben extends PlausiChecker
{
	public function executePlausiCheck($params)
	{
		...
		$prestudentRes = $this->_getNameGebdatumFehlt(
	...
	/**
	 * Name and birthdate missing at same time.
	 ...
	 */
	private function _getNameGebdatumFehlt(
		...
		$status_kurzbz = $this->_ci->config->item('fhc_dvuh_status_kurzbz')['DVUHRequestMatrikelnummer'] ?? null;
		...
		$qry = "
			...
			WHERE
				(pers.vorname IS NULL OR pers.vorname = '' OR pers.nachname IS NULL OR pers.nachname = '')
				AND pers.gebdatum IS NULL
